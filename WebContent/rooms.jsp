            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
					...
					if(request.getAttribute("allRooms")==null){
						System.out.println("convos empty");
					}else{ %>
						<div class="list-group-item">
						<% 
						ArrayList<String> allRooms = (ArrayList<String>) request.getAttribute("allRooms");
						for(String roomName : allRooms){
						%>
						<a href="roomChatWindow.jsp?roomName=<%=roomName%>"><%=roomName %></a><br>
						<% }%>
						</div>
						<%} %>
                </div>
